...
const EPIC_SUNDAY_CALENDAR_URL = `https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=NTRwNmtxYTFrNzFydW1uN2Z0bG1zZGlnODggZmF0dGFoQHhlbmRpdC5jbw&tmsrc=fattah%40xendit.co`
